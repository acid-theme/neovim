...
local groups = {
  ...
  GitSignsAddInline = { bg = "#454620" },
  GitSignsChangeInline = { bg = "#394249" },
  GitSignsDeleteInline = { bg = "#562e27" },

  -- mini.diff
  MiniDiffSignAdd = { fg = p.green },
  MiniDiffSignChange = { fg = p.blue },
  MiniDiffSignDelete = { fg = p.red },
  MiniDiffOverAdd = { bg = "#34351d" },
  MiniDiffOverChange = { bg = "#2d3236" },
  MiniDiffOverChangeBuf = { bg = "#3b444d" },
  MiniDiffOverContext = { bg = p.surface0 },
  MiniDiffOverContextBuf = { bg = p.surface1 },
  MiniDiffOverDelete = { bg = "#3f2621" },
